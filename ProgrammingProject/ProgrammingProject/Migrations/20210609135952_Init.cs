        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_People_BookerId",
                        column: x => x.BookerId,
            ...
            migrationBuilder.InsertData(
                table: "Sittings",
                columns: new[] { "Id", "Capacity", "End", "IsClosed", "Name", "RestaurantId", "SittingTypeId", "Start" },
                values: new object[,]
                {
                    { 1, 30, new DateTime(2021, 6, 9, 10, 0, 0, 0, DateTimeKind.Local), false, "Breakfast Today", 1, 1, new DateTime(2021, 6, 9, 7, 0, 0, 0, DateTimeKind.Local) },
                    { 4, 30, new DateTime(2021, 6, 10, 10, 0, 0, 0, DateTimeKind.Local), false, "Breakfast Tomorrow", 1, 1, new DateTime(2021, 6, 10, 7, 0, 0, 0, DateTimeKind.Local) },
                    { 2, 30, new DateTime(2021, 6, 9, 14, 0, 0, 0, DateTimeKind.Local), false, "Lunch Today", 1, 2, new DateTime(2021, 6, 9, 11, 0, 0, 0, DateTimeKind.Local) },
                    { 5, 30, new DateTime(2021, 6, 10, 14, 0, 0, 0, DateTimeKind.Local), false, "Lunch Tomorrow", 1, 2, new DateTime(2021, 6, 10, 11, 0, 0, 0, DateTimeKind.Local) },
                    { 3, 30, new DateTime(2021, 6, 9, 20, 0, 0, 0, DateTimeKind.Local), false, "Dinner Today", 1, 3, new DateTime(2021, 6, 9, 17, 0, 0, 0, DateTimeKind.Local) },
                    { 6, 30, new DateTime(2021, 6, 10, 20, 0, 0, 0, DateTimeKind.Local), false, "Dinner Tomorrow", 1, 3, new DateTime(2021, 6, 10, 17, 0, 0, 0, DateTimeKind.Local) }
                });
